...
Options:
  ...
  --local-rpc URL          Local RPC URL (default: http://127.0.0.1:${EVM_PORT:-8545})
...
Examples:
  ./check_sync.sh --public-rpc https://node.mainnet.etherlink.com
  ./check_sync.sh --compose-service evm --public-rpc https://node.mainnet.etherlink.com
  CONTAINER=evm-1 PUBLIC_RPC=https://node.mainnet.etherlink.com ./check_sync.sh
EOF
}
...
LOCAL_RPC="${LOCAL_RPC:-http://127.0.0.1:${EVM_PORT:-8545}}"
PUBLIC_RPC="${PUBLIC_RPC:-}"
